...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    _createClass(Contacts, [{
	        ...
	        value: function render() {
	            var conLi = ["旺串演", "牛烘烘", "白佐", "赵烈"].map(function (name) {
	                return _react2["default"].createElement("li", null, name);
	            });
	...
	_react2["default"].render(_react2["default"].createElement(Contacts, null), document.body);

	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(211); if (makeExportsHot(module, __webpack_require__(66))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "demoes6.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
